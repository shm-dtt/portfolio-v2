...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className=" flex flex-col h-screen items-center justify-center bg-light-black">
      <div className=" flex flex-col items-center justify-center z-1 pointer-events-none text-primary-gray lg:text-7xl md:text-5xl text-4xl text-center uppercase">
        <div>
