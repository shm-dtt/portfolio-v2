...
description: Learn how to create a real-time Spotify "Now Playing" component for your Next.js website, including authentication, API integration, and a responsive React UI.
date: 2025-04-13
published: true
---
...
<div className="rounded-md p-2 bg-neutral-800 text-xs flex flex-col gap-3 items-center text-neutral-400">
  <Image
    src="/images/blog/spotify-blog/playing.png"
    alt="Playing State"
...
<div className="rounded-md p-2 bg-neutral-800 text-xs flex flex-col gap-3 items-center text-neutral-400">
  <Image
    src="/images/blog/spotify-blog/info.png"
